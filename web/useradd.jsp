...
function deleteRecord(id){
 ...
 <div> <input type="dob" placeholder="Date of birth" name="DOB"></div><br>
 
 
 <div> <input type="text" placeholder="Username" name="Username"></div><br>
 
 
 <div> <input type="Password" placeholder="Password" name="Password"></div><br>
